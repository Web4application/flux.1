 ## Documentation [flux.2](https://docs.bfl.ml/llms.txt)
...
<Update label="March 3, 2026">
  ...
  * **Same API contract** — Drop-in upgrade, no code changes required
  ...
  Learn more in the [Preview Endpoint documentation](/flux_2/flux2_overview#preview-endpoint).
</Update>
...
<Update label="December 16, 2025">
  ...
  * Historical moments from specific dates and locations
  ...
  Try it in the [playground](https://playground.bfl.ml) or via the [API](/flux_2/flux2_text_to_image).
</Update>
